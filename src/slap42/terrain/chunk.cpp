...
Chunk::Chunk(int x, int z) {
  ...
  for (size_t z = 0; z < kChunkSize; ++z) {
    for (size_t x = 0; x < kChunkSize; ++x) {
      ...
      vertices[i +  0] = 0.0f + (float)x; vertices[i +  1] = 0.0f; vertices[i +  2] = 1.0f + (float)z; vertices[i +  3] = 0.0f; vertices[i +  4] = 1.0f;
      vertices[i +  5] = 1.0f + (float)x; vertices[i +  6] = 0.0f; vertices[i +  7] = 1.0f + (float)z; vertices[i +  8] = 1.0f; vertices[i +  9] = 1.0f;
      vertices[i + 10] = 0.0f + (float)x; vertices[i + 11] = 0.0f; vertices[i + 12] = 0.0f + (float)z; vertices[i + 13] = 0.0f; vertices[i + 14] = 0.0f;
      vertices[i + 15] = 1.0f + (float)x; vertices[i + 16] = 0.0f; vertices[i + 17] = 0.0f + (float)z; vertices[i + 18] = 1.0f; vertices[i + 19] = 0.0f;
