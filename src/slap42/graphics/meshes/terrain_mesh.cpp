...
TerrainMesh::TerrainMesh(float* vertices, size_t vertices_size_bytes, unsigned short* indices, size_t indices_size_bytes)
  ...
  GL_CHECK(glVertexAttribPointer(1, 1, GL_FLOAT, GL_FALSE, kVertexSize * sizeof(float), (void*)(3 * sizeof(float))));
  GL_CHECK(glEnableVertexAttribArray(1));
  GL_CHECK(glVertexAttribPointer(2, 3, GL_FLOAT, GL_FALSE, kVertexSize * sizeof(float), (void*)(4 * sizeof(float))));
